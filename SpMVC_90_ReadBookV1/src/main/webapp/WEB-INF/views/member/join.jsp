	...
	<div class="container">
		<div class="login-box">
			<div class="main-subject">
				<a href="${rootPath}/">회원가입</a>
			</div>
			<form:form modelAttribute="memberDTO" autocomplete="on"
				class="user-form">
				<div class="text-box">아이디</div>
				<form:input path="m_id" type="text" placeholder="사용할 ID를 입력하세요" />
				<br />
				<button id="id_check" class="check-btn" type="button">중복확인
				</button>
				...
				<div>
					<form:input path="m_password" type="password"
						class="text-box-warning" placeholder="8자리 이상 입력하세요" />
					<br />
