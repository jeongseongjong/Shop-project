...
public class UserDetailsServiceImpl implements UserDetailsService {
	 ...
	 * 
	 * 만약 @Require...를  사용하지 않으려면
	 * 클래스 생성자를 만들고 생성자에 @Autowired를 붙여서 초기화 해주어야한다.
	 */
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		// spring security가 사용할 DeatilVO 선언
...
//		userDetails.setPassword(userVO.getPassword());
		...
		// 사용자정보를 사용할 수 있는가 아닌가를 세밀하게 제어하기 위한 칼럼
		...
		userDetails.setEmail("abcd@naver.com");
