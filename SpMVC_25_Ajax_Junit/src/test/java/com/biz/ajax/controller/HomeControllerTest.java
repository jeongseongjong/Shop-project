...
public class HomeControllerTest {
	...
	public void setUp() throws Exception {
		// @Injectmocks로 설정한 클래스의 의존성 주입( 초기화를 시키는 코드)
	...
	public void testHome() throws Exception {
		System.out.println();
		// http://localhost:8080/로 requst 요청하라
		// controller가 상태코드를 200을 response 했느냐
		// 라고 test를 수행
		mockMvc.perform(get("/"))
		
				// Controller의 응답코드가 200인가?
